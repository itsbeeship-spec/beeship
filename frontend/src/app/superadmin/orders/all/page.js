    ...
    <SectionLayout section={SECTION} tabs={TABS}>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center select-none pb-1 border-b border-[#1e293b]/40">
          <div>
            <h2 className="text-sm font-black text-white">All Orders</h2>
            <p className="text-[10px] text-slate-500 mt-0.5">View and monitor orders across all sellers.</p>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 select-none">
          {[
            { label: "Total Orders", val: meta.counts.total, color: "slate", border: "border-[#1e293b] bg-slate-500/5 text-slate-300" },
            { label: "New/Pending",  val: meta.counts.new,   color: "amber", border: "border-amber-500/15 bg-amber-500/5 text-amber-400" },
            { label: "Processing",   val: meta.counts.processing, color: "indigo", border: "border-indigo-500/15 bg-indigo-500/5 text-indigo-400" },
            { label: "Delivered",    val: meta.counts.delivered, color: "emerald", border: "border-emerald-500/15 bg-emerald-500/5 text-emerald-400" },
            { label: "Cancelled",    val: meta.counts.cancelled, color: "rose", border: "border-rose-500/15 bg-rose-500/5 text-rose-400" },
          ].map((item) => (
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={8} className="py-20 text-center">
                      <p className="text-xs font-bold text-slate-500">No orders found matching parameters.</p>
                    </td>
                  </tr>
                ) : (
                  orders.map((ord) => {
