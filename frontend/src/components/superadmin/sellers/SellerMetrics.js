...
export default function SellerMetrics({ metrics = {} }) {
  const list = [
    {
      label: "Total Sellers",
    ...
    {
      label: "Suspended",
      value: metrics.suspendedSellers ?? 0,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      value: metrics.notSubmittedKycSellers ?? 0,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6M12 9v6m9-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      ),
    ...
    {
      label: "Rejected KYC",
      value: metrics.rejectedKycSellers ?? 0,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
