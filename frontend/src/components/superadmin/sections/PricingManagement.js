...
import RateCalculatorConfigTab from "../pricing/RateCalculatorConfigTab";
...
const TABS = [
  ...
  { id: "rate-calculator-control", label: "Rate Calculator Control", href: "/superadmin/pricing/rate-calculator-control", icon: "🧮", description: "Configure Base & Additional rates for Rate Calculator.", features: ["Set Zone-wise First 0.5kg Base Rate", "Set Zone-wise Extra 0.5kg Additional Rate", "Set Slab step size (0.5kg / 1.0kg)", "Live Rate Calculator Control"] },
...
export default function PricingManagement({ activeTab }) {
  ...
  } else if (activeTab === "rate-calculator-control") {
    content = <RateCalculatorConfigTab />;
