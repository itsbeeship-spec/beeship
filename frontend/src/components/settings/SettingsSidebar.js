...
const SETTINGS_NAV = [
  {
    href: "/settings/auto-assign-couriers",
  ...
  {
    href: "/settings/product-tax-mapping",
        ...
        {SETTINGS_NAV.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center justify-between w-full px-4 py-3 rounded-xl border transition-all text-xs font-bold text-left ${
                isActive
            ...
            >
              <div className="flex items-center gap-3">
                <span className={`transition ${isActive ? "text-blue-600" : "text-slate-400"}`}>
                  {item.icon}
                </span>
